...
class ChatManager:
    ...
    def setup_voiceline_save_location(self, in_game_voice_folder):
        ...
        in_game_volce_folder = f"{self.mod_folder}/{in_game_voice_folder}/"
        if not os.path.exists(in_game_volce_folder):
            os.mkdir(in_game_volce_folder)
            ...
            for file_name in os.listdir(example_folder):
                ...
                if os.path.isfile(source_file_path):
                    shutil.copy(source_file_path, in_game_volce_folder)
