...
class ConfigValueInt(ConfigValueNumeric[int]):
    def __init__(self, identifier: str, name: str, description: str, default_value: int, min_value: int, max_value: int, constraints: list[ConfigValueConstraint[int]] = [], is_hidden: bool = False, tags: list[ConvigValueTag] = []):
