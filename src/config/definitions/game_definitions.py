...
Please see here to learn where to set this value: https://art-from-the-machine.github.io/Mantella/pages/installation.html#setup-configuration""")
    ...
    def get_game_config_value() -> ConfigValue:
        return ConfigValueSelection("game","Game","Choose the game to use with Mantella","SkyrimVR",["Skyrim", "SkyrimVR", "Fallout4", "Fallout4VR"])
    
    @staticmethod
    def get_skyrim_mod_folder_config_value() -> ConfigValue:
        identifier = "skyrim_mod_folder"
        game_folder = "Skyrim Special Edition"
        return ConfigValuePath(identifier, "Path to MantellaSpell mod", GameDefinitions.MOD_FOLDER_DESCRIPTION.format(game_folder), "C:\\Modding\\MO2\\mods\\Mantella","Sound",[GameDefinitions.ProgramFilesChecker(game_folder), GameDefinitions.ModFolderChecker(identifier)])
    ...
    def get_fallout4_mod_folder_config_value() -> ConfigValue:
        ...
        return ConfigValuePath(identifier, "Path to MantellaGun mod", GameDefinitions.MOD_FOLDER_DESCRIPTION.format(game_folder), "C:\\Modding\\MO2\\mods\\Mantella","Sound",[GameDefinitions.ProgramFilesChecker(game_folder), GameDefinitions.ModFolderChecker(identifier)])
