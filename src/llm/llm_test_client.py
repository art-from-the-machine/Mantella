...
class LLMTestClient(AIClient):
    ...
    async def streaming_call(self, messages: Message | message_thread, is_multi_npc: bool, tools: list[dict] = None) -> AsyncGenerator[str | None, None]:
    ...
    def get_model_list(service: str, default_model: str = "google/gemma-4-26b-a4b-it:free", is_vision: bool = False, is_tool_calling: bool = False, show_key_error: bool = False) -> LLMModelList:
        ...
        Args:
            ...
            default_model (_type_, optional): _description_. Defaults to "google/gemma-4-26b-a4b-it:free".
