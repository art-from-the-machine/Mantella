...
class sentence:
    ...
    def __init__(self, speaker: Character, sentence: str, voice_file: str, voice_line_duration: float, 
                 is_system_generated_sentence: bool = False, error_message: str | None = None) -> None:
